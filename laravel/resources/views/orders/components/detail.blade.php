...
<dt>商品名</dt>
<dd>
        <select  v-model="orders.products_id"
...
<dt>オプション名</dt>
<dd>
            <select  v-model="orders.products_options_id">
        <option value="0"> 選択してください。</option>
...
{{--          <dd>
           <div class="inputFlex dateBlock">
            <select name="date_year" v-model="customers.date_year" id="">
                <option value="{{ $customers->date_year }}">{{ $customers->date_year }}年</option>
                <option value="{{ $customers->date_year + 1 }}">{{ $customers->date_year + 1 }}年</option>
            </select>
